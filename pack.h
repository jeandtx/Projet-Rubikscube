...
void train(T_COLOR ***cube){

    for (int i = 0; i < 3; i++){
        cube[select_side(RIGHT)][1][i] = cube[select_side(UP)][1][i];
    }
    for (int i = 0; i < 3; i++){
        cube[select_side(UP)][1][i] = cube[select_side(LEFT)][1][i];
    }
    for (int i = 0; i < 3; i++){
        cube[select_side(LEFT)][1][i] = cube[select_side(DOWN)][1][i];
    }
    for (int i = 0; i < 3; i++){
        cube[select_side(DOWN)][1][i] = cube[select_side(RIGHT)][1][i];
    }
}
